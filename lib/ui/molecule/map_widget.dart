...
const LatLng SOURCE_LOCATION = LatLng(44.870, 13.870);
const LatLng DEST_LOCATION = LatLng(49.870, 18.870);
...
// for my drawn routes on the map
  ...
  String googleAPIKey = "<AIzaSyDmdyzFEPPoABQKV_w4pCDJozcky9GRPpY>";
...
// wrapper around the location API
  ...
  void initState() {
    ...
    location.onLocationChanged.listen((LocationData cLoc) {
      // cLoc contains the lat and long of the current user's position in real time,
